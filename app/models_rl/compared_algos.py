...
for lr in learning_rates:
    for ep in episodes_list:
        for ed in epsilon_decays:
            prefix = f"save/test_lr{lr}_ep{ep}_ed{ed}"
...
plt.legend()
plt.savefig(f'save/test_reward_algos.png')
...
plt.legend()
plt.savefig(f'save/test_time_algos.png')
...
summary_table.to_csv('save/test_model_comparison_summary.csv', index=False)